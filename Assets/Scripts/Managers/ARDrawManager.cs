...
/*
  Ajustes de dibujo que recoge los valores de los ajustes de la línea
  y delerfecie captada y que garantiza la posibilidad de dibujar en el
  espacio y en tres dimensiones.
*/
